          ...
          <div className="bg-white rounded-xl shadow-2xl w-full max-w-2xl max-h-[80vh] overflow-y-auto transform transition-all duration-300 ease-in-out">
            <div className="p-6">
              ...
              <div className="space-y-4">
                {loginHistory.length > 0 ? (
                  loginHistory.slice(0, 5).map((login, index) => (
                    <div 
                      key={index} 
                      className="p-4 border rounded-lg hover:shadow-md transition-shadow duration-200 bg-gradient-to-r from-gray-50 to-white"
                    >
              ...
              <div className="flex justify-end mt-6 pt-4 border-t">
                <button
                  onClick={() => setShowLoginHistoryModal(false)}
                  className="px-6 py-2 text-gray-700 bg-gray-100 rounded-lg hover:bg-gray-200 transition-colors duration-200 flex items-center space-x-2"
                >
            ...
            <div className="p-6">
              ...
              <div className="flex justify-end mt-6 pt-4 border-t space-x-3">
                ...
                <button
                  ...
                  className="px-6 py-2 text-white bg-green-500 rounded-lg hover:bg-green-600 disabled:opacity-50 transition-colors duration-200 flex items-center space-x-2"
                >
                  {isChangingPassword ? (
                    <>
